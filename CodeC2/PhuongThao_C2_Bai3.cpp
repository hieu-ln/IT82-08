//Chuong 2 - Bai 3 : Danh sách lien ket don
#include <stdio.h>
#include <iostream>
using namespace std;
...
//Cau 3.5: Chen mot phan tu vao dau danh sach
...
//Cau3.6: Xoa mot phan tu dau danh sach
int Delete_first()
{
	if (first != NULL)
	{
...
//Cau 3.7: Them phan tu vao cuoi danh sach
...
//Cau 3.9: Tim phan tu trong danh sach, xoa neu co
...
//Cau 3.11: Sap xep danh sach theo thu tu giam dan
void SortDesc()
{
